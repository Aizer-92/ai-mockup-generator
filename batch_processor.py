...
🚨 ТРЕБОВАНИЕ К РАЗМЕРУ: Все генерируемые изображения должны быть 1024x1024 пикселей (квадратные) 🚨
...
🚨 ВАЖНО: Все генерируемые изображения должны быть в формате 1024x1024 пикселей (квадратные) 🚨
