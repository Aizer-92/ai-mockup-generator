...
def single_generation_interface():
    ...
    with col3:
        ...
        add_tag = st.checkbox("Добавить бирку", value=False, help="Добавить ценник или бирку к товару")
            ...
            if st.button("🚀 Сгенерировать мокапы", type="primary", use_container_width=True):
                with st.spinner("Генерация мокапов..."):
                    try:
                        ...
                        if add_tag:
                            extended_prompt += " Добавить ценник или бирку к товару."
                        if add_person:
...
def batch_processing_interface():
    ...
    if product_files and logo_file:
        ...
        with col2:
            ...
            add_tag = st.checkbox("Добавить бирки", value=False, help="Добавить ценники к товарам")
